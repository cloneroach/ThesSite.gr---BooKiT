...
class BookitgoldViewRoomedit extends JView

{
...

	{
		...
		$roomcategories        =& $this->get('RoomCategories');

	

			$this->assignRef('roomcategories', $roomcategories );
		...
		if ($isNew)  {
			...
			$roomcategory        =& $this->get('RoomCategory');

			$this->assignRef('roomCategory', $roomcategory);
