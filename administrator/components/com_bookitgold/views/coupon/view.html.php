...
class BookitgoldViewCoupon extends JView

{
...

	{
		...
		JToolBarHelper::title( JText::_( 'Coupons Manager' ), 'generic.png' );
		...
		$filter_order = $app->getUserStateFromRequest('com_bookitgold.filter_order','filter_order', 'name');
