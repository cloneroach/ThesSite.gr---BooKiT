...
class BookitgoldControllerSpecialoffer extends BookitgoldController

{
...

	{
		...
		JRequest::setVar( 'view', 'specialoffer' );
...

	{
		...
		JRequest::setVar( 'view', 'specialofferedit' );
...

	{
		...
		$model = $this->getModel('specialoffer');

		if(!$model->delete()) {

			$msg = JText::_( 'Error: One or More Offers Could not be Deleted' );

		} else {

			$msg = JText::_( 'Offer(s) Deleted' );

		}



		$this->setRedirect( 'index.php?option=com_bookitgold&controller=specialoffer&task=listing', $msg );
...

	{
		...
		if(!$model->copy()) {
			...
			$msg = JText::_( 'Error: One or More Offers Could not be Copied' );

		} else {

			$msg = JText::_( 'Offer(s) Copied' );
