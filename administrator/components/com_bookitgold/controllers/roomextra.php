...
class BookitgoldControllerRoomextra extends BookitgoldController

{
...

	{
		...
		JRequest::setVar( 'view', 'roomextraedit' );
...

	{
		...
		$this->setRedirect( 'index.php?option=com_bookitgold&controller=roomextra&task=listing', $msg );
...

	{
		...
		if(!$model->copy()) {
			...
			$msg = JText::_( 'Error: One or More Services Could not be Copied' );

		} else {

			$msg = JText::_( 'Service(s) Copied' );
