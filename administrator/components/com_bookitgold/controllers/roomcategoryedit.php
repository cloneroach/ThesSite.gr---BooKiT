...
class BookitgoldControllerRoomcategoryedit extends BookitgoldController

{
	...
	$model = $this->getModel('roomcategoryedit');

		$res = $model->store();

		

		$link = 'index.php?option=com_bookitgold&controller=roomcategory&task=edit&cid[]='.$res["id"];

		if ($res["code"]==0) {

				

				$msg = JText::_( 'Room Category Saved' )."!";
			...
			$this->setRedirect($link, $msg);
				...
				$msg = JText::_( 'Error Saving Room Category' );
			...
			$this->setRedirect($link, $msg, 'error');
				...
				$msg = JText::_( 'Please complete all basic fields. Number of guest and cost must be positive numbers' );
...

	{
		...
		$res = $model->store();
			...
			$link = 'index.php?option=com_bookitgold&controller=roomcategory&task=listing';
