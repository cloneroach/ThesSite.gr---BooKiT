...
class BookitgoldModelRoomextra extends JModel
{
	var $_data;
	var $_total = null;
...
$mainframe = JFactory::getApplication();
	...
	function _buildCopyQuery($id)
	{
		...
		$data->extra_type = $row['2'];
		$data->value_fix = $row['3'];
		$data->value_percent = $row['4'];
		$data->value_type = $row['5'];
		$data->description = $row['6'];
		
		$db->insertObject( '#__bookitextra', $data, 'idextra' );
		return true;
	}
